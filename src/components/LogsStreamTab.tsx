                ...
                return (
                  <button
                    ...
                    className={`w-full text-left p-3.5 rounded-xl border transition-all flex flex-col gap-1.5 cursor-pointer ${
                      isSelected ? "bg-slate-900 text-white border-slate-900 shadow-md" : "bg-slate-50 hover:bg-slate-100/50 border-slate-200"
                    }`}
                  >
                    ...
                    <strong className={`text-xs block font-mono line-clamp-1 ${isSelected ? "text-indigo-300" : "text-slate-900"}`}>
                      {log.exceptionName}
                    </strong>
